...
//     FutureProvider.family<EventModel, String>((ref, url) async {
// // this causes re-evaluation on refresh
...
// ///=====================modifying events with any appld filter or search================================

// final filteredEventsProvider = Provider.family<EventModel, String>((ref, url) {
//   final data = ref.watch(eventListProvider(url));
...
/// Replace this with your actual default URL
